...
<body id="top">
   ...
   ================================================== -->
    ...
    <!-- home
   ================================================== -->
    <section id="home" data-parallax="scroll" data-image-src="{{ asset('backend/images/hero-bg.jpg') }}" data-natural-width=3000
        ...
        <div class="home-content">
            ...
            <div class="row contents">
                <div class="home-content-left">
                    ...
                    <h3 data-aos="fade-up">Chào mừng bạn đến với XMusicG</h3>
                ...
                <div class="home-image-right">
                    <img src="{{ asset('backend/images/iphone-app-470.png') }}"
                        srcset="{{ asset('backend/images/iphone-app-470.png 1x, backend/images/iphone-app-940.png 2x') }}" data-aos="fade-up">
                </div>
            </div>
    ...
    <section id="about">
        ...
        <div class="row about-bottom-image">
            ...
            <img src="{{ asset('backend/images/app-screens-1200.png') }}" srcset="{{ asset('backend/images/app-screens-1200.png 1200w,
                        backend/images/app-screens-2800.png 2800w') }}" sizes="(max-width: 2800px) 100vw, 2800px"
                ...
                <div class="slides owl-carousel">
                    ...
                    <div>
                        ...
                        <div class="testimonial-author">
                            <img src="{{ asset('backend/images/avatars/user-02.jpg') }}" alt="Author image">
                    ...
                    <div>
                        ...
                        <div class="testimonial-author">
                            <img src="{{ asset('backend/images/avatars/user-03.jpg') }}" alt="Author image">
                            <div class="author-info">
                                John Doe
        ...
        <div class="row">
            <div class="col-full">
                ...
                <ul class="download-badges">
                    <li><a href="{{ URL::to('apk/app-debug.apk') }}" title="" class="badge-appstore" data-aos="fade-up">App Store</a></li>
                    <li><a href="{{ URL::to('apk/app-debug.apk') }}" title="" class="badge-googleplay" data-aos="fade-up">Play Store</a></li>
                </ul>
    ...
    <!-- Java Script
    ================================================== -->
    <script src="{{ asset('/backend/js/jquery-2.1.3.min.js') }}"></script>
